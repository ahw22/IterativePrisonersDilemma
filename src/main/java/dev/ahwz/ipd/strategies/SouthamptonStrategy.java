...
public class SouthamptonStrategy implements Strategy {
    ...
    public SouthamptonStrategy(List<Action> code, double certaintyThreshold, boolean isSacrifice) {
        this.code = code;
    ...
    public String getName() {
        return "Southampton " + (isSacrifice ? "Sacrifice" : "Master");
    }
